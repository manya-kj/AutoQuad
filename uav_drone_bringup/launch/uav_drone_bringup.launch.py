...
def generate_launch_description():
    uav_drone_bringup_path = get_package_share_directory('uav_drone_bringup')

    rviz_path = os.path.join(
        uav_drone_bringup_path, "rviz", "rviz.rviz"
    )
    
    yaml_file_path = os.path.join(
        get_package_share_directory('uav_drone_bringup'),
        'config', 'drone.yaml'
    )
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(uav_drone_bringup_path, 'launch', 'uav_drone_gazebo.launch.py')
            )
        ),
